...
pub fn CONNECT(core: *Core, allocator: Allocator, co: protocol.ConnectOpts, io: std.Io) !void {
    core.io = io;
    ...
    try core.createConn(allocator, co, core.io);
...
fn createConn(core: *Core, allocator: Allocator, co: protocol.ConnectOpts, io: std.Io) !void {
