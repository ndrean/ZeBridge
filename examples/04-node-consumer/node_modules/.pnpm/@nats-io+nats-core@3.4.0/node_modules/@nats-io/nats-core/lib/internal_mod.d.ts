...
export type { Auth, Authenticator, CallbackFn, CallbackOptionalErrorFn, ClientPingStatus, CloseStatus, ClusterUpdateStatus, ConnectionClosedListener, ConnectionOptions, DisconnectStatus, Dispatcher, ForceReconnectStatus, JwtAuth, LDMStatus, Msg, MsgCallback, MsgHdrs, Nanos, NatsConnection, NKeyAuth, NoAuth, Payload, Publisher, PublishOptions, QueuedIterator, ReconnectingStatus, ReconnectStatus, ReconnectToServerHandler, Request, RequestManyOptions, RequestOptions, RequestStrategy, ReviverFn, Server, ServerErrorStatus, ServerInfo, ServersChanged, SlowConsumerStatus, StaleConnectionStatus, Stats, Status, SubOpts, Subscription, SubscriptionOptions, SyncIterator, TlsOptions, TokenAuth, UserPass, } from "./core";
