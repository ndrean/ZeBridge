import type { MsgHdrs, Nanos, Payload, QueuedIterator, RequestOptions, ReviverFn, WithRequired } from "@nats-io/nats-core";
import type { ConsumerCreateOptions, DeliverPolicy, DirectLastFor, PrioritizedOptions, PullOptions, ReplayPolicy } from "./jsapi_types";
import type { ConsumerConfig, ConsumerInfo, ConsumerResetResponse, ConsumerUpdateConfig, DirectBatchOptions, DirectMsgRequest, JetStreamAccountStats, MsgRequest, OverflowOptions, PurgeOpts, PurgeResponse, StreamAlternate, StreamConfig, StreamInfo, StreamInfoRequestOptions, StreamUpdateConfig } from "./jsapi_types";
 ...
 */
export type PredefinedSchedule = "@yearly" | "@annually" | "@monthly" | "@weekly" | "@daily" | "@midnight" | "@hourly";
/**
...
export type ConsumerAPI = {
     ...
     * @param opts
     */
    add(stream: string, cfg: Partial<ConsumerConfig>, opts?: ConsumerCreateOptions): Promise<ConsumerInfo>;
    /**
     ...
     */
    reset(stream: string, name: string, seq?: number): Promise<ConsumerResetResponse>;
};
/**
...
export type PushConsumerOptions = ConsumeCallback & AbortOnMissingResource;
export type NextOptions = Expires & Bind;
export type ConsumeBytes = MaxBytes & Partial<MaxMessages> & Partial<ThresholdBytes> & Expires & IdleHeartbeat & ConsumeCallback & AbortOnMissingResource & Bind & Partial<OverflowOptions> & Partial<PrioritizedOptions>;
export type ConsumeMessages = Partial<MaxMessages> & Partial<ThresholdMessages> & Expires & IdleHeartbeat & ConsumeCallback & AbortOnMissingResource & Bind & Partial<OverflowOptions> & Partial<PrioritizedOptions>;
export type ConsumeOptions = ConsumeBytes | ConsumeMessages;
/**
 * Options for fetching bytes
 */
export type FetchBytes = MaxBytes & Partial<MaxMessages> & Expires & IdleHeartbeat & Bind & Partial<OverflowOptions> & Partial<PrioritizedOptions>;
/**
 * Options for fetching messages
 */
export type FetchMessages = Partial<MaxMessages> & Expires & IdleHeartbeat & Bind & Partial<OverflowOptions> & Partial<PrioritizedOptions>;
 ...
 */
export type ConsumerNotification = HeartbeatsMissed | ConsumerNotFound | StreamNotFound | ConsumerDeleted | OrderedConsumerRecreated | ExceededLimits | Debug | Discard | Reset | Next | Heartbeat | FlowControl | NoResponders | ConsumerPinned | ConsumerUnpinned;
/**
...
export type PushConsumer = InfoableConsumer & DeleteableConsumer & ConsumerKind & {
...
export declare function isOrderedPushConsumerOptions(v: unknown): v is OrderedPushConsumerOptions;
export declare function isPullConsumer(v: PushConsumer | Consumer): v is Consumer;
export declare function isPushConsumer(v: PushConsumer | Consumer): v is PushConsumer;
/**
...
export type FastIngest = {
     ...
     */
    add(subj: string, payload?: Payload, opts?: Partial<JetStreamPublishOptions>): Promise<FastIngestProgress>;
    /**
     ...
     */
    last(subj: string, payload?: Payload, opts?: Partial<JetStreamPublishOptions>): Promise<BatchAck>;
    /**
...
export type BatchMessageOptions = Partial<Omit<JetStreamPublishOptions, "msgID" | "expect">> & {
 ...
 * atomically. The batch has several limits imposed by the server,
 * such as a batch may not contain more than 1000 messages (including
 * the message starting and ending the batch. And no more than 50
 * batches on a stream can be active. Batches that are inactive for more
 * than 10 seconds, are abandoned by the server.
 *
 * For more information check the JetStream
 * documentation.
 */
export type Batch = {
    /**
     * The unique identifier for the batch, generated by the client when the
     * batch is created.
     */
    readonly id: string;
    /**
     ...
     * @param opts
     */
    add(subj: string, payload?: Payload, opts?: Partial<BatchMessageOptions>): void;
    /**
     ...
     * @param opts
     */
    add(subj: string, payload?: Payload, opts?: Partial<BatchMessageOptionsWithReply>): Promise<void>;
    /**
     * Commits the batch. This will publish the last message on the batch
     * and will remove the batch from the client.
     * @param subj
     * @param payload
     * @param opts
     */
...
export declare function isBoundPushConsumerOptions(v: unknown): v is BoundPushConsumerOptions;
/**
...
export type DirectStreamAPI = {
     ...
     * This API is Non-Stable and subject to change.
     */
    getLastMessagesFor(stream: string, opts: DirectLastFor): Promise<QueuedIterator<StoredMsg>>;
};
/**
 ...
 */
export declare const AdvisoryKind: {
    readonly API: "api_audit";
    readonly StreamAction: "stream_action";
    readonly ConsumerAction: "consumer_action";
    readonly SnapshotCreate: "snapshot_create";
    readonly SnapshotComplete: "snapshot_complete";
    readonly RestoreCreate: "restore_create";
    readonly RestoreComplete: "restore_complete";
    readonly MaxDeliver: "max_deliver";
    readonly Terminated: "terminated";
    readonly Ack: "consumer_ack";
    readonly StreamLeaderElected: "stream_leader_elected";
    readonly StreamQuorumLost: "stream_quorum_lost";
    readonly ConsumerLeaderElected: "consumer_leader_elected";
    readonly ConsumerQuorumLost: "consumer_quorum_lost";
};
...
export declare const JsHeaders: {
    /**
     * Set if message is from a stream source - format is `stream seq`
     */
    readonly StreamSourceHdr: "Nats-Stream-Source";
    /**
     * Set for heartbeat messages
     */
    readonly LastConsumerSeqHdr: "Nats-Last-Consumer";
    /**
     * Set for heartbeat messages
     */
    readonly LastStreamSeqHdr: "Nats-Last-Stream";
    /**
     * Set for heartbeat messages if the consumer is stalled, reply subject
     * will unstall the client when the client responds
     */
    readonly ConsumerStalledHdr: "Nats-Consumer-Stalled";
    /**
     * Set for headers_only consumers indicates the number of bytes in the payload
     */
    readonly MessageSizeHdr: "Nats-Msg-Size";
    readonly RollupHdr: "Nats-Rollup";
    readonly RollupValueSubject: "sub";
    readonly RollupValueAll: "all";
    /**
     * Set on protocol messages to indicate pull request message count that
     * was not honored.
     */
    readonly PendingMessagesHdr: "Nats-Pending-Messages";
    /**
     * Set on protocol messages to indicate pull request byte count that
     * was not honored
     */
    readonly PendingBytesHdr: "Nats-Pending-Bytes";
    /**
     * Asserts a minimum JetStream API level on a JS API request (ADR-44).
     */
    readonly RequiredApiLevel: "Nats-Required-Api-Level";
};
export type JsHeaders = typeof JsHeaders[keyof typeof JsHeaders];
export declare const DirectMsgHeaders: {
    readonly Stream: "Nats-Stream";
    readonly Sequence: "Nats-Sequence";
    readonly TimeStamp: "Nats-Time-Stamp";
    readonly Subject: "Nats-Subject";
    readonly LastSequence: "Nats-Last-Sequence";
    readonly NumPending: "Nats-Num-Pending";
};
export type DirectMsgHeaders = typeof DirectMsgHeaders[keyof typeof DirectMsgHeaders];
export declare const RepublishHeaders: {
    /**
