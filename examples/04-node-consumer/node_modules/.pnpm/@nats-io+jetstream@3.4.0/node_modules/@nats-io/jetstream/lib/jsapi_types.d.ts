...
import type { MaxBytes, StoredMsg } from "./types";
...
export declare const RetentionPolicy: {
    /**
...
export declare const DiscardPolicy: {
    /**
...
export declare const DeliverPolicy: {
    /**
...
export declare const AckPolicy: {
     ...
     */
    readonly FlowControl: "flow_control";
    /**
     * @ignore
     */
    readonly NotSet: "";
...
export declare const StoreCompression: {
    /**
     * No compression
     */
    readonly None: "none";
 ...
 */
export type LastForMsgRequest = {
    "last_by_subj": string;
};
/**
 * Stream sequence number of the message to retrieve
 */
export type SeqMsgRequest = {
    seq: number;
};
/**
 ...
 * 2.11.0 and better.
 */
export type StartTimeMsgRequest = {
    start_time: Date | string;
};
export type DirectMsgRequest = SeqMsgRequest | LastForMsgRequest | NextMsgRequest | StartTimeMsgRequest;
...
export declare const ConsumerApiAction: {
...
export declare const PriorityPolicy: {
    readonly None: "none";
    readonly Overflow: "overflow";
    readonly PinnedClient: "pinned_client";
 ...
 */
export type PullOptions = Partial<OverflowMinPendingAndMinAck> & Partial<PrioritizedOptions> & {
    /**
...
export declare const PubHeaders: {
    readonly MsgIdHdr: "Nats-Msg-Id";
    readonly ExpectedStreamHdr: "Nats-Expected-Stream";
    readonly ExpectedLastSeqHdr: "Nats-Expected-Last-Sequence";
    readonly ExpectedLastMsgIdHdr: "Nats-Expected-Last-Msg-Id";
    readonly ExpectedLastSubjectSequenceHdr: "Nats-Expected-Last-Subject-Sequence";
    readonly ExpectedLastSubjectSequenceSubjectHdr: "Nats-Expected-Last-Subject-Sequence-Subject";
    /**
     * Sets the TTL for a message (Nanos value). Only have effect on streams that
     * enable `StreamConfig.allow_msg_ttl`.
     */
    readonly MessageTTL: "Nats-TTL";
    readonly Schedule: "Nats-Schedule";
    readonly ScheduleTarget: "Nats-Schedule-Target";
    readonly ScheduleSource: "Nats-Schedule-Source";
    readonly ScheduleTTL: "Nats-Schedule-TTL";
    readonly ScheduleTimeZone: "Nats-Schedule-Time-Zone";
    readonly ScheduleRollup: "Nats-Schedule-Rollup";
    /**
     ...
     */
    readonly Scheduler: "Nats-Scheduler";
    /**
     ...
     */
    readonly ScheduleNext: "Nats-Schedule-Next";
};
