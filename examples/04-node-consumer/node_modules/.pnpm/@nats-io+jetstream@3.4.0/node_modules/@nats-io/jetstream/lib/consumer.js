...
class PullConsumerMessagesImpl extends internal_1.QueuedIteratorImpl {
        ...
        this.sub = this.consumer.api.nc.subscribe(this.inbox, {
            callback: (err, msg) => {
                ...
                if (this.isConsume) {
                    ...
                    if ((max_messages && this.pending.msgs <= threshold_messages) ||
    ...
    async resetPendingWithInfo() {
        ...
        const bo = (0, internal_1.backoff)([this.opts.expires || 30_000]);
        let attempt = 0;
        while (true) {
            if (this.done) {
                return false;
...
class PullConsumerImpl {
    ...
    async next(opts = { expires: 30_000 }) {
        opts = { ...opts };
        const fopts = opts;
