...
export declare const KvWatchInclude: {
    /**
     ...
     */
    readonly AllHistory: "history";
    /**
     * Don't include history or last values, only notify
     * of updates
     */
    readonly UpdatesOnly: "updates";
};
...
export type KV = RoKV & {
     ...
     */
    update(k: string, data: Payload, version: number, timeout?: number): Promise<number>;
    /**
