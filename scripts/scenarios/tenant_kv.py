#!/usr/bin/env python3
"""$KV.tenants.<principal> — self-discovery, exact-key scoping, and live propagation.
...
fail. The live-propagation checks need a running bridge and are skipped — not failed —
if no update arrives within their timeout; every other check needs only NATS.
"""
